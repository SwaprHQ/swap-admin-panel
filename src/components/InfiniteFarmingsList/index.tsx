...
function InfiniteFarmingItem({
  ...
  return (
    <ListItem>
      ...
      <span>
        ...
        {!addRewardsToggled && !removeRewardsToggled ? (
          <>
            ...
            <EditButton
              disabled={isDeactivated || rewardToken.id === ADDRESS_ZERO}
      ...
      <span>
        ...
        {!addBonusRewardsToggled && !removeBonusRewardsToggled ? (
          <>
            ...
            <EditButton
              disabled={isDeactivated || bonusRewardToken.id === ADDRESS_ZERO}
      ...
      <span>
        {!isDeactivated ? (
          <DetachButton onClick={() => deactivateCallback(rewardToken.id, bonusRewardToken.id, pool, nonce)}>
            Detach
          </DetachButton>
        ) : (
